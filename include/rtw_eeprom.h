...
void eeprom_write16(struct adapter *adapter, u16 reg, u16 data);
u16 eeprom_read16(struct adapter *adapter, u16 reg);
void read_eeprom_content(struct adapter *adapter);
void eeprom_read_sz(struct adapter *adapt, u16 reg, u8 *data, u32 sz);
void read_eeprom_content_by_attrib(struct adapter *adapter);
